...
traced_model_bcls.save("/home/ajvalenc/OneDrive - University of Ottawa/Projects/spectronix/thermal/Cpp_Codes/weights/traced_bcls-{}.pt".format(device).replace(":0",""))
...
traced_model_bdet.save("/home/ajvalenc/OneDrive - University of Ottawa/Projects/spectronix/thermal/Cpp_Codes/weights/traced_bdet-{}.pt".format(device).replace(":0",""))
...
traced_model_fdet.save("/home/ajvalenc/OneDrive - University of Ottawa/Projects/spectronix/thermal/Cpp_Codes/weights/traced_fdet-{}.pt".format(device).replace(":0",""))
